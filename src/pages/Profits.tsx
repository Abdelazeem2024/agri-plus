...
export default function Profits() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showChange && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4 overflow-y-auto" onClick={() => setShowChange(false)}>
          <form onClick={e => e.stopPropagation()} onSubmit={handleChangePassword}
            className="bg-surface rounded-2xl p-6 w-full max-w-md shadow-xl space-y-4 border border-slate-200 dark:border-slate-600 my-6">
